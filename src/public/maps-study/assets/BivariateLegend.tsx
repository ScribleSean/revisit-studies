...
function BivariateLegend({
  ...
  useEffect(() => {
    ...
    legendGroup.append('text')
      .attr('transform', `translate(${legendWidth / 2 + 10}, ${legendHeight + 50})`)
      .attr('text-anchor', 'middle')
    ...
    legendGroup.append('text')
      .attr('transform', `translate(-50, ${legendHeight / 2}) rotate(-270)`)
      .attr('text-anchor', 'middle')
      .style('font-size', '14px')
      .attr('fill', '#67aebf')
      .style('font-weight', 'bold')
    ...
    legendGroup.append('line')
      .attr('x1', -10)
      .attr('y1', legendHeight - (avgColumnBPercentage) * legendHeight - 37)
      .attr('x2', legendWidth + 8)
      .attr('y2', legendHeight - (avgColumnBPercentage) * legendHeight - 37)
      .attr('stroke', '#333')
      .attr('stroke-dasharray', 2);

    legendGroup.append('text')
      .attr('transform', `translate(${legendWidth + 10}, ${legendHeight - avgColumnBPercentage * legendHeight - 25}) rotate(45) `)
      .attr('text-anchor', 'left')
      .attr('dy', '-12px')
      .attr('dx', '-5px')
      .attr('fill', '#999')
