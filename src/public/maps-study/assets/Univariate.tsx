...
function UniVariate(props: StimulusParams<Parameters, ProvenanceStateModel>) {
  ...
  return (
    <div>
      ...
      <div>
        {/* <Button onClick={handleRecordAnswers} disabled={(hasDrawing || (taskid === 'uNarrate-3')) ? false : selectedCounties.length !== 5 || isAnalysis} mt="10" color="lime">Next</Button> */}
        {/* <Button ref={nextButtonRef} onClick={handleRecordAnswers} disabled={!nextButtonEnabled} mt="10" color="lime">Next</Button> */}
